    ...
    return (
        <div className="bg-muted/30 flex w-full flex-col border-r lg:w-80">
            <div className="flex-1 overflow-y-auto p-4">
                <Tabs value={mode} onValueChange={(value) => setMode(value as "simple" | "custom")}>
                    ...
                    <TabsContent value="simple" className="mt-6 space-y-6">
                        ...
                        {/* Lyrics button ansd instrumentals toggle */}
                    ...
                    <TabsContent value="custom" className="mt-6 space-y-6">
                        <div className="flex flex-col gap-3">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-1">
                                    <Button 
                                        ...
                                        onClick={() => {setLyricsMode("auto"); setLyrics("");}}
                                        size="sm" 
                                    ...
                                    <Button 
                                        ...
                                        onClick={() => {setLyricsMode("write"); setLyrics("");}}
                                        size="sm" 
                                        className="h-7 text-xs"
                                    >
                                        Write
                            ...
                            <Textarea 
                                placeholder={lyricsMode === "write" ? "Add your own lyrics here" : "Describe your lyrics, e.g., 2hollis type beat"}
                                value={lyrics} 
            ...
            <div className="border-t p-4">
                <Button onClick={() => handleCreate()} disabled={loading} className="w-full cursor-pointer bg-gradient-to-r from-orange-500 to-pink-500 font-medium text-white hover:from-orange-600 hover:to-pink-600">
