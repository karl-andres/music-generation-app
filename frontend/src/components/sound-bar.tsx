                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex min-w-0 flex-1 items-center gap-2">
                            <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-md bg-gradient-to-br from-purple-500 to-pink-500">
                                {track?.artwork ? <img src={track.artwork} className="h-full w-full rounded-md object-cover" /> : <Music className="h-4 w-4 text-white" />}
                            </div>
                        ...
                        <div className="flex items-center gap-1">
                            <div className="flex items-center gap-2">
                                ...
                                <Slider value={volume} onValueChange={setVolume} step={1} min={0} max={100} className="w-16" />
                            </div>
                            <DropdownMenu>
